...
import com.note.quarter.MainForm;
...
public class ImageResource {
    ...
    private static Image staff = new Image(MainForm.class.getResource("images/staff.png").toString());
    private static Image clef = new Image(MainForm.class.getResource("images/gclef.png").toString());
    private static Image barLine = new Image(MainForm.class.getResource("images/barLine.png").toString());
    private static Image meter = new Image(MainForm.class.getResource("images/commontime.png").toString());


    static {
        for(NoteRestValue value : NoteRestValue.values()) {
            String name = value.name().toLowerCase();
            upNotes.put(value, new Image(MainForm.class.getResource("images/notes/up/" + name + ".png").toString()));
            downNotes.put(value, new Image(MainForm.class.getResource("images/notes/down/" + name + ".png").toString()));
            sharpNotes.put(value, new Image(MainForm.class.getResource("images/notes/sharp/" + name + ".png").toString()));
            rests.put(value, new Image(MainForm.class.getResource("images/rests/" + name + ".png").toString()));
            additionals.put(value,new Image(MainForm.class.getResource("images/additionals/"+"additional_"+name+".png").toString()));
        }
    }
